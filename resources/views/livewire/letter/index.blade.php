      ...
      <div class="bg-gradient-to-r from-slate-700 to-slate-800 px-8 py-6 border-b-4 border-blue-600">
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-4 lg:space-y-0">
          <div class="flex items-center space-x-4">
            ...
            <div>
              <h1 class="text-2xl font-bold text-white">Letter Submissions</h1>
              <p class="text-blue-100 text-sm font-medium">Kelola Submission Anda</p>
            </div>
          </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
      ...
      <div>
        ...
        <input type="text" wire:model.live="search"
          class="block w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 text-sm"
      ...
      {{-- Items Per Page --}}
      <div>
        <label class="block text-sm font-bold text-gray-700 mb-2">Tampilkan</label>
