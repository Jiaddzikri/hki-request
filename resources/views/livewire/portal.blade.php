    ...
    <header class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
      <div class="flex items-center space-x-4">
        <div class="flex-shrink-0 w-16 h-16 rounded-lg flex items-center justify-center">
          <img src="/unsap-1.png" alt="Logo Universitas Sebelas April">
        </div>
        <div>
          <h1 class="text-sm lg:text-2xl font-bold text-gray-900 ">
            Portal Layanan LPPM
          </h1>
          <p class="mt-1 text-gray-600 text-[0.75rem] lg:text-sm">
