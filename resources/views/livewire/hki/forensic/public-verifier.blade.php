<div class="min-h-screen flex flex-col items-center justify-center bg-gray-50 px-4 py-12 sm:px-6 lg:px-8">
    ...
    <div class="max-w-md w-full space-y-8 bg-white p-10 rounded-xl shadow-2xl border border-gray-100">
        ...
        @if($isForensicsDisabled)
            {{-- KONDISI 0: FORENSICS DISABLED (UJI PERFORMA) --}}
            <div class="text-center">
                ...
                <h2 class="mt-2 text-2xl font-extrabold text-orange-600">
                    Sistem Log Forensik Tidak Aktif
                </h2>
                <p class="mt-2 text-sm text-gray-600 font-bold">
                    Sistem sedang dalam mode uji performa.
                </p>
                <p class="mt-1 text-xs text-gray-500">
                    Validasi integritas kriptografi tidak dapat dilakukan karena fitur *Immutable Logging* dinonaktifkan.
                </p>
