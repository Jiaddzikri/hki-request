        ...
        @if($step === 1)
          <div class="space-y-6">
            ...
            <div>
              ...
              <x-select.styled class='py-2 px-4 disabled:bg-slate-100' id="hki_type_parent" wire:model.live="hki_type_id"
                      ...
                      <div class="grid grid-cols-1 gap-4 sm:grid-cols-12 sm:items-end">
                        ...
                        <div class="sm:col-span-12">
                          <label for="abstract" class="block font-medium text-sm text-gray-700">
                            ...
                            provinsi, kabupaten/kota, kecamatan, kelurahan/desa, kode pos) <span class="text-red-500">*</span>
                          </label>
        ...
        <div class="space-y-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="bg-white p-4 rounded-lg border border-gray-200 shadow-sm md:col-span-2">
              ...
              @error('uploads.contoh_ciptaan') <span class="text-red-500 text-xs block mt-1">{{ $message }}</span>
              @enderror
            </div>
