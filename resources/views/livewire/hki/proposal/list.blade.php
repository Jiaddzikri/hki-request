            ...
            <div class="bg-gradient-to-r from-indigo-600 to-purple-600 px-6 py-6">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-4 sm:space-y-0">
                    <div class="flex items-center space-x-4">
                        ...
                        <div>
                            <h1 class="text-2xl font-bold text-white">Dashboard HKI Saya</h1>
                            <p class="text-indigo-100 text-sm mt-1">Kelola pengajuan Hak Kekayaan Intelektual Anda</p>
                        </div>
                    </div>

                    <a href="{{ route('hki.create') }}"
                        class="inline-flex items-center px-6 py-3 bg-white text-indigo-600 rounded-lg font-semibold text-sm hover: transform hover:-translate-y-0.5 transition-all duration-200 hover:bg-indigo-50">
    ...
    <div class="bg-white rounded-2xl  overflow-hidden border border-indigo-100">
        ...
        @if($proposals->isEmpty())
            <div class="p-16 text-center">
                <div
                    class="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-indigo-100 to-purple-100 rounded-full mb-6">
                ...
                <a href="{{ route('hki.create') }}"
                    class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-lg font-semibold text-sm hover: transform hover:-translate-y-0.5 transition-all duration-200">
                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path>
                    </svg>
        ...
        @else
            ...
            <div class="bg-gradient-to-r from-gray-50 to-indigo-50 px-6 py-4 border-b border-indigo-100">
                <div class="flex items-center space-x-2">
                    ...
                    <h3 class="text-lg font-semibold text-gray-800">Daftar Pengajuan HKI</h3>
                </div>
            </div>
                            ...
                            <tr class="hover:bg-indigo-50/30 transition-colors duration-150">
                                <td class="px-6 py-4">
                                    <div class="flex items-start space-x-3">
                                        ...
                                        <div class="min-w-0 flex-1">
                                            <div class="text-sm font-semibold text-gray-900 truncate max-w-xs hover:text-indigo-600 transition-colors"
                                                title="{{ $p->title }}">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <a href="{{ route('hki.show', $p->id) }}"
                                        class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-lg font-semibold text-xs hover transform hover:-translate-y-0.5 transition-all duration-200">
        ...
        <div class="flex items-start space-x-3">
            ...
            <div class="text-sm text-gray-600">
                ...
                <div class="space-y-1.5">
                    <div class="flex items-center space-x-2">
                        <span
                            class="px-2 py-0.5 rounded-full bg-gray-100 text-gray-800 text-xs font-medium">DRAFT</span>
                        <span>- Dokumen masih dalam tahap penyusunan</span>
                    </div>
                    <div class="flex items-center space-x-2">
                        <span
                            class="px-2 py-0.5 rounded-full bg-blue-100 text-blue-800 text-xs font-medium">SUBMITTED</span>
                        <span>- Dokumen telah diajukan dan menunggu review</span>
                    </div>
                    <div class="flex items-center space-x-2">
                        <span
                            class="px-2 py-0.5 rounded-full bg-green-100 text-green-800 text-xs font-medium">APPROVED</span>
