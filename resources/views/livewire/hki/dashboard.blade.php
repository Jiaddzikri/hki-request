  ...
  <div class="max-w-7xl mx-auto px-2 py-2">
    ...
    <div class="mb-8">
      <div class="bg-white rounded-lg shadow-sm overflow-hidden border border-gray-200">
        <div class="bg-blue-800 px-8 py-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
      ...
      <div
        ...
        <div class="p-6">
          <div class="flex items-center justify-between mb-4">
            <div class="flex-shrink-0 w-14 h-14 bg-blue-800 rounded-lg flex items-center justify-center">
      ...
      <div
        ...
        <div class="p-6">
          <div class="flex items-center justify-between mb-4">
            <div class="flex-shrink-0 w-14 h-14 bg-yellow-500 rounded-lg flex items-center justify-center">
              <svg class="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
      ...
      <div
        ...
        <div class="p-6">
          <div class="flex items-center justify-between mb-4">
            <div class="flex-shrink-0 w-14 h-14 bg-green-600 rounded-lg flex items-center justify-center">
              <svg class="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
      ...
      <div
        ...
        <div class="p-6">
          <div class="flex items-center justify-between mb-4">
            <div class="flex-shrink-0 w-14 h-14 bg-red-600 rounded-lg flex items-center justify-center">
              <svg class="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                  ...
                  @foreach($recentProposals as $p)
                    <tr class="hover:bg-indigo-50/30 transition-colors duration-150">
                      ...
                      <td class="px-6 py-4 text-center">
                        ...
                        @endphp
                        <span
                          class="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold shadow-sm {{ $config['bg'] }} {{ $config['text'] }}">
