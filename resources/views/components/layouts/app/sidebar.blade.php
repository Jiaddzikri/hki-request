...
<body class="min-h-screen bg-gray-50">
  <flux:sidebar sticky stashable class="border-e-2 border-blue-800 bg-white">
    ...
    <flux:navlist variant="outline">
      ...
      @else
        ...
        <flux:navlist.group heading="Sentra HKI">
          <flux:navlist.item icon="document-plus" href="{{ route('hki.create') }}"
        ...
        <flux:navlist.group heading="Administrasi Penelitian">
          <flux:navlist.item icon="academic-cap" href="{{ route('letter.create') }}"
    ...
    <flux:dropdown class="hidden lg:block" position="bottom" align="start">
      <flux:profile :name="auth()->user()->name"
        :avatar="auth()->user()->profile_photo_url ?? asset('images/default-avatar.png')"
            ...
            <div class="flex items-center gap-2 px-1 py-1.5 text-start text-sm">
              <span class="relative flex h-8 w-8 shrink-0 overflow-hidden rounded-lg">
                <img class="w-full h-full"
                  src="{{ auth()->user()->profile_photo_url ?? asset('images/default-avatar.png') }}" alt="">
              </span>
  ...
  <flux:header class="lg:hidden">
    ...
    <flux:dropdown position="top" align="end">
      ...
      <flux:profile :avatar="auth()->user()->profile_photo_url ?? asset('images/default-avatar.png')"
