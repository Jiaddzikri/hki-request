...
/*
|--------------------------------------------------------------------------
| 1. PORTAL UTAMA (Layanan LPPM)
|--------------------------------------------------------------------------
|
*/
// Tidak lagi menggunakan skema subdomain
...
|--------------------------------------------------------------------------
*/
Route::prefix('hki')->middleware(['auth', 'security-keys'])->group(function () {
    ...
    // Route::get('/setup-security', SetupSecurity::class)->name('setup.security'); // Dimatikan (karena sudah ada di Portal Utama)
