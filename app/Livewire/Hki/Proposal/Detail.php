...
class Detail extends Component
{
    ...
    {
        $this->auditResults = $auditLogService->verifyChain();

        if ($this->auditResults['is_valid']) {
            session()->flash('success', 'Audit Hash Chain berhasil: Seluruh rantai audit valid dan tidak ada manipulasi data yang terdeteksi.');
        } else {
            session()->flash('error', 'Audit Hash Chain gagal: Terdeteksi ketidakkonsistenan pada rantai audit.');
        }
    }
